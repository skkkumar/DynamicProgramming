...
imageObject.getImage('resources/images/Girl-with-Book-Grayscale.jpg', false);


%% make search space by imaginary countour lines

searchObject = SearchSpace();
searchObject.makeSearchSpace('resources/init9.ctr','resources/init10.ctr', imageObject.imageMatrix, 60);
